          ...
          <ul className="space-y-3 mt-10 justify-center items-center">
            ...
            <li className="flex gap-2 items-center"><span><IoMail className="text-red-500" /></span>cbpsrourkela@gmail.com</li>
               ...
               <div className='flex flex-col mb-4'>
                ...
                <select name="gender" id="gender" className="shadow border rounded-lg px-3 py-2 text-gray-700 leading-tight focus:outline-none" required>
               ...
               <div className='flex flex-col mb-4'>
                ...
                <select name="city" id="city" className="shadow border rounded-lg px-3 py-2 text-gray-700 leading-tight focus:outline-none" required>
                    <option value="s">SELECT</option>
               ...
               <div className='flex flex-col mb-4'>
                ...
                <select name="course" id="course" className="shadow border rounded-lg px-3 py-2 text-gray-700 leading-tight focus:outline-none" required>
                <option value="s">SELECT</option>
            ...
            <div className='flex flex-col mb-4'>
                ...
                <input className='shadow appearance-none border rounded-lg px-3 py-2 text-gray-700 leading-tight focus:outline-none' type="phone" name="phone" placeholder="Enter any other course" />
            </div>
            <div className='flex flex-col mb-4'>
                <label className='block text-gray-700'>Type of course </label>
                <select name="coursetype" id="coursetype" className="shadow border rounded-lg px-3 py-2 text-gray-700 leading-tight focus:outline-none" required>
                <option value="s">SELECT</option>
