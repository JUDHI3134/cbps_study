  ...
  return (
    <>
      ...
      <div>
        ...
        <ul className='mt-3'>
            <li className='font-semibold list-disc'>Dropped and Discontinued Students</li>
            <li className='font-semibold list-disc'>Working Professionals</li>
            <li className='font-semibold list-disc'>Regular Students</li>
        </ul>
      </div>
      <div className='mt-8'>
      ...
      <div className='flex flex-col md:flex-row justify-between gap-11 mt-12 space-y-2 mb-12'>
        ...
        <ul className='mt-8 space-y-1'>
          ...
          <li className='list-disc ml-1'><span className='font-semibold text-blue-600'>Graduation Courses</span> - BA, BCOM, BSC, BBA, BCA, BSW, B.Lib</li>
          <li className='list-disc ml-1'><span className='font-semibold text-blue-600'>Post-Graduation Courses</span> - MA, MCOM, MSC, MBA, MCA, MSW, M.Lib</li>
